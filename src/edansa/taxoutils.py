...
def row2yaml_codev2(row, excell_names2code):
    ...
    yaml_codes = []
    excell_class_names = {
        'whim','amgp','shorebird','spsa','paja','hola',
        'sngo','lalo','savs','wipt','nora','atsp','wisn','wfgo','sesa','glgu',
...
excell_all_headers = [
    'data_version', 'Annotator','region', 'Site ID', 'Comments', 'File Name', 'Date',
    'Start Time', 'End Time', 'Length',
    'WHIM','AMGP','SHOREBIRD','SPSA','PAJA','HOLA',
    'SNGO','LALO','SAVS','WIPT','NORA','ATSP','WISN','WFGO','SESA','GLGU', # new from John's labels
     'Anth', 'Bio', 'Geo', 'Sil', 'Auto',
    ...
    'Clip Path','Reviewed','extra_tags'
]
excell_label_headers = [
    'WHIM','AMGP','SHOREBIRD','SPSA','PAJA','HOLA',
    'SNGO','LALO','SAVS','WIPT','NORA','ATSP','WISN','WFGO','SESA','GLGU', # new from John's labels
    'Anth', 'Bio', 'Geo', 'Sil', 'Auto', 'Airc', 'Mach', 'Flare', 'Bird', 'Mam',
